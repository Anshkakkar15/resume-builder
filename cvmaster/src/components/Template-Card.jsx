...
export const TemplateCard = ({ temlates }) => {
  ...
  return (
    <CarouselItem key={temlates.id} className="basis-1/1">
      <div
        onMouseEnter={() => setHovered(true)}
        onMouseLeave={() => setHovered(false)}
        className={`relative ${isHovered ? "tempelate-overlay" : ""}`}
      >
        ...
        <div className="absolute left-[50%] top-[50%] z-10 -translate-x-2/4 -translate-y-2/4">
          <motion.button
            ...
            className="rounded-xl bg-light-blue px-3 py-2 font-semibold text-dark-blue"
          >
            Use Template
          </motion.button>
        </div>
